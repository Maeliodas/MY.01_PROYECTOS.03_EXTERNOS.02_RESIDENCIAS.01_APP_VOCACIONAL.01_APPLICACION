...
class AvatarConfig {
  ...
  factory AvatarConfig.initial() {
    return const AvatarConfig(
      baseAvatarId: 'avatar_01',
      avatarPath: 'assets/avatars/avatar_01.png',
    );
  }
  ...
  factory AvatarConfig.fromMap(Map<String, dynamic> map) {
    return AvatarConfig(
      baseAvatarId: map['baseAvatarId'] as String? ?? 'avatar_01',
      avatarPath: map['avatarPath'] as String? ?? 'assets/avatars/avatar_01.png',
