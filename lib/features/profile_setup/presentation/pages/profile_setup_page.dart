        ...
        children: [
          schools.when(
            data: (items) => DropdownButtonFormField<String>(
              ...
              decoration:
                  const InputDecoration(labelText: 'Escuela de procedencia'),
              items: items
                  .map(
            ...
            error: (err, stack) => const Text('No fue posible cargar escuelas'),
          ),
          ...
          if (mother)
            mothers.when(
              data: (items) => _LanguageMultiSelector(
                ...
                custom: customMother,
                onCustomChanged: (values) => setState(() {
                  customMother
                    ..clear()
                    ..addAll(values);
                }),
          ...
          FilledButton(
            onPressed: schoolId == null ? null : _save,
          ...
          ...custom.map(
            (name) => ListTile(
              ...
              trailing: IconButton(
                ...
                onPressed: () =>
                    onCustomChanged(custom.where((e) => e != name).toList()),
              ),
            ),
          ),
        ],
