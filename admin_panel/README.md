...
Esquema `1.2.0-0` → versión **1**, sub modificación semigrande **2**, subcambios menores **0**, revisión **0**. Independiente de la app (`1.3.2-10`) y de la versión de **datos** (`catalog_meta`, visible como `#N` en el panel).
