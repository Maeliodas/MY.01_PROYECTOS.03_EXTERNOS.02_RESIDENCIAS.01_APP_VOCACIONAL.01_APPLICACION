...
Esquema `1.2.2-7` → versión **1**, sub modificación semigrande **2**, subcambios menores **2**, revisión **7**. Independiente de la app (`1.3.2-10`) y de la versión de **datos** (`catalog_meta`, visible como `#N` en el panel).
